...
enum L10n {
    ...
    private static let table: [String: [String: String]] = [
        ...
        "mac.nodes.hubSmart.sub": ["zh": "自动选延迟最低节点", "en": "Auto pick lowest latency"],
        "mac.nodes.hubLB": ["zh": "负载均衡", "en": "Load Balance"],
        "mac.nodes.hubLB.sub": ["zh": "节点失败立刻换下一条", "en": "Swap instantly on failure"],
        "mac.nodes.hubFO": ["zh": "故障转移", "en": "Failover"],
        "mac.nodes.hubFO.sub": ["zh": "按顺序切换到可用节点", "en": "Fall through to healthy node"],
        ...
        "mac.groups.subtitle": [
            "zh": "为业务流量选手动节点（左名称 · 右当前选择）",
            "en": "Pick a node per service (name · current)",
        ],
