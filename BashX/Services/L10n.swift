...
enum L10n {
    ...
    private static let table: [String: [String: String]] = [
        ...
        "proxy.rule.sub": ["zh": "按规则分流", "en": "Route by rules"],
        "proxy.global.sub": ["zh": "全部走代理", "en": "All via proxy"],
        "proxy.direct.sub": ["zh": "不走代理", "en": "No proxy"],
        ...
        "plugin.market.hint": [
            "zh": "以 PC/网页插件为主，开启后请重连",
            "en": "PC/web packs · reconnect after enabling",
        ],
        ...
        "groups.strategy.smart": ["zh": "智能策略", "en": "Smart"],
        "groups.strategy.balance": ["zh": "负载均衡", "en": "Load balance"],
        "groups.strategy.failover": ["zh": "故障转移", "en": "Failover"],
        ...
        "mac.adblock.hint": [
            "zh": "拦截视频广告与开屏 SDK（需规则模式）",
            "en": "Blocks video ads & splash SDKs (Rule mode)",
        ],
        "mac.youtube.adblock.section": ["zh": "YouTube 去广告", "en": "YouTube Ad Block"],
        "mac.youtube.adblock": ["zh": "拦截 YouTube 广告", "en": "Block YouTube ads"],
        "mac.youtube.adblock.hint": [
            "zh": "拦截片前/中插广告域名（需规则模式，YouTube 需走代理）",
            "en": "Blocks pre/mid-roll ad domains (Rule mode; YouTube via proxy)",
        ],
        "mac.youtube.adblock.footer": [
            "zh": "可拦截 Google 广告 SDK 与 YouTube 广告域名；无法去除与视频同 CDN 的广告。",
            "en": "Blocks Google ad SDK & YouTube ad domains; same-CDN ads may still appear.",
        ],
        "mac.youtube.adblock.rules": ["zh": "拦截规则", "en": "Rules"],
        ...
        "mac.nodes.adblock.sub": ["zh": "拦截视频/跳转广告", "en": "Block video & ad redirects"],
        ...
        "mac.apps.subtitle": [
            "zh": "按应用指定线路",
            "en": "Route apps by line",
        ],
        "mac.apps.add": ["zh": "添加应用", "en": "Add app"],
        "mac.apps.empty": ["zh": "还没有应用分组", "en": "No app routes yet"],
        "mac.apps.emptyHint": [
            "zh": "如 Chrome 走美国、Telegram 走香港",
            "en": "e.g. Chrome→US, Telegram→HK",
        ],
        ...
        "mac.systemProxy.hint": [
            "zh": "指向 127.0.0.1:%@，关闭时自动恢复",
            "en": "Points to 127.0.0.1:%@; restores on disable",
        ],
        ...
        "mac.launchAtLogin.hint": [
            "zh": "登录后自动运行（菜单栏）",
            "en": "Runs in the menu bar at login",
        ],
        ...
        "mac.proxy.lanHint": [
            "zh": "允许局域网访问 mixed-port",
            "en": "Let LAN reach mixed-port",
        ],
        "mac.proxy.portHint": [
            "zh": "改端口后需重启内核",
            "en": "Restart core after changing port",
        ],
        ...
        "mac.core.defaultPorts": [
            "zh": "默认 17890/19090，避免与其他客户端冲突",
            "en": "Defaults 17890/19090 to avoid conflicts",
        ],
        "mac.core.stack": ["zh": "协议栈", "en": "Stack"],
        "mac.core.tunHint": [
            "zh": "启动内核时可能请求一次管理员权限",
            "en": "May ask for admin once at core start",
        ],
        "mac.core.maint": ["zh": "维护", "en": "Maintenance"],
        "mac.core.dashHint": [
            "zh": "连接 / 日志 / 规则可视化",
            "en": "Connections, logs & rules UI",
        ],
        "mac.core.bundled": [
            "zh": "mihomo 已内置，自动安装运行",
            "en": "mihomo bundled; auto-installed",
        ],
        "mac.core.stop": ["zh": "停止内核", "en": "Stop core"],
        "mac.core.start": ["zh": "启动内核", "en": "Start core"],
        "mac.launchDiag.header": ["zh": "启动诊断", "en": "Launch diagnostics"],
        "mac.launchDiag.title": ["zh": "启动异常，可查看日志排查", "en": "Launch issue — see logs below"],
        "mac.launchDiag.detail": ["zh": "诊断日志", "en": "Diagnostic log"],
        "mac.launchDiag.empty": ["zh": "暂无日志", "en": "No log yet"],
        "mac.launchDiag.copy": ["zh": "复制日志", "en": "Copy log"],
        "mac.launchDiag.openLog": ["zh": "打开日志文件", "en": "Open log file"],
        ...
        "mac.update.available": ["zh": "发现新版本 %@", "en": "New version %@ available"],
        "mac.update.pkgSize": ["zh": "安装包 %@", "en": "Package %@"],
        "mac.update.downloading": ["zh": "正在下载… %@%", "en": "Downloading… %@%"],
        "mac.update.banner": ["zh": "新版本 %@", "en": "New version %@"],
        "mac.update.bannerUpgrade": ["zh": "升级", "en": "Update"],
        "mac.update.bannerDismiss": ["zh": "关闭提醒", "en": "Dismiss"],
        "mac.update.bannerDownloading": ["zh": "下载中 %@%", "en": "Downloading %@%"],
