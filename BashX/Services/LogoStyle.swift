...
enum LogoStyle: String, CaseIterable, Identifiable, Codable {
    ...
    var palette: LogoStylePalette {
        switch self {
        case .markX:
            // BashX default — bright solid yellow field, dark X (dock must read as yellow).
            return .init(
                deep: CGColor(red: 0.98, green: 0.78, blue: 0.08, alpha: 1),
                mid: CGColor(red: 1.0, green: 0.86, blue: 0.14, alpha: 1),
                accent: CGColor(red: 1.0, green: 0.92, blue: 0.28, alpha: 1),
                rim: CGColor(red: 1.0, green: 0.96, blue: 0.55, alpha: 0.65),
                ink: CGColor(red: 0.10, green: 0.08, blue: 0.02, alpha: 1),
                inkSoft: CGColor(red: 0.22, green: 0.16, blue: 0.04, alpha: 1)
            )
        case .bolt:
...
enum LogoPalette {
    ...
    static let brandMid = LogoStyle.markX.palette.mid
